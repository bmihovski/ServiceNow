...
public class PropertiesFactory {
	...
	public Map<String, String> getObjectProperties(){
		...
		//ServiceNow
		//map.put("loginlinkInHomepage", "//input[@class='login ng-pristine ng-valid ng-touched']");
		map.put("usernametextbox", "//*[@id='user_name']");
		map.put("passwordtextbox", "//*[@id='user_password']");
		map.put("siginInbtn", "#sysverb_login");
		map.put("userInfo", "#user_info_dropdown");
		map.put("logOutlink", "//a[text()='Logout']");
   ...
   //carwale
	...
	//Amazon.com
		  ...
		  map.put("amazoncomiphone6s", "//h2[contains(text(),'Apple iPhone 6s 16 GB International Warranty Unlocked Cellphone - Retail Packaging (Rose Gold)')]");
